...
class OptionStore {
    ...
    resetStore(store) {
        if (store === "local") {
            ...
            chrome.storage.sync.remove(["webtoon", "visists", "scorlls", "favorate", "sortWebtoon"], () => {
                this.resetOption();
            });
        }
    }
