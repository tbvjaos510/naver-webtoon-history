...
function default_1(webtoon, option) {
    whale.runtime.onMessage.addListener((message, sender, response) => {
        ...
        if (message && message.command === "openTab") {
            ...
            link_1.default.openNewTab(link);
            response(null);
        }
