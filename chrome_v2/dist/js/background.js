...
class WebtoonStore {
    constructor(option) {
        ...
        this.storage.get(["webtoon", "visits", "scrolls", "favorate", "sortWebtoon", "imglog"], value => {
            ...
            if (value.imglog)
                this._imglog = JSON.parse(value.imglog);
